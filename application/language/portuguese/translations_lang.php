...
$lang['retype_password'] = 'Digite novamente a palavra-passe';
...
$lang['page_not_found_message'] = 'Infelizmente, a página que você solicitou não existe. Por favor, verifique a URL no seu navegador ou dirija-se a outro local utilizando os botões abaixo.';
$lang['error'] = 'Fechado';
...
$lang['require_captcha'] = 'Requerer CAPTCHA';
$lang['require_captcha_hint'] = 'Quando ativado, os clientes terão de digitar uma string CAPTCHA gerada aleatoriamente antes de marcar/atualizar uma consulta.';
$lang['captcha_is_wrong'] = 'A verificação CAPTCHA falhou, por favor tente novamente.';
$lang['any_provider'] = 'Qualquer Fornecedor';
$lang['requested_hour_is_unavailable'] = 'A consulta solicitada não está disponível. Por favor, selecione uma hora diferente para a sua consulta.';
$lang['customer_notifications'] = 'Notificações de Clientes';
$lang['customer_notifications_hint'] = 'Define se o cliente receberá notificações por e-mail sempre que houver uma alteração na programação de uma das suas consultas.';
...
$lang['google_analytics_code_hint'] = 'Adicione o seu ID do Google Analytics para ser incluído na página de reservas.';
$lang['availabilities_type'] = 'Tipo de Disponibilidades';
$lang['flexible'] = 'Flexível';
$lang['fixed'] = 'Fixo';
$lang['attendants_number'] = 'Número de Assistentes';
$lang['reset_working_plan'] = 'Reiniciar o plano de trabalho para os valores padrão.';
...
$lang['display_privacy_policy'] = 'Mostrar Política de Privacidade';
$lang['privacy_policy_content'] = 'Conteúdo da Política de Privacidade';
$lang['website_using_cookies_to_ensure_best_experience'] = 'Este site usa cookies para garantir que você tenha a melhor experiência possível.';
...
$lang['delete_personal_information_hint'] = 'Remover todas as suas consultas e informações pessoais do sistema.';
$lang['delete_personal_information'] = 'Eliminar Informações Pessoais';
$lang['delete_personal_information_prompt'] = 'Tem certeza de que deseja eliminar as suas informações pessoais? Esta ação não pode ser desfeita.';
...
$lang['working_plan_exception_deleted'] = 'Exceção ao plano de trabalho eliminada com sucesso.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Adicionar exceções ao plano de trabalho, fora do plano de trabalho.';
$lang['add_working_plan_exception'] = 'Adicionar Exceção ao Plano de Trabalho';
$lang['require_phone_number'] = 'Requerer número de telefone';
$lang['require_phone_number_hint'] = 'Quando ativado, os clientes e utilizadores precisarão inserir o número de telefone do cliente ao marcar uma consulta.';
$lang['check_spam_folder'] = 'Por favor, verifique a sua pasta de spam se o e-mail não chegar dentro de alguns minutos.';
...
$lang['overwrite_existing_working_plans'] = 'Isto irá substituir os planos de trabalho existentes dos fornecedores. Tem certeza de que deseja continuar?';
...
$lang['display_any_provider'] = 'Mostrar Opção Qualquer Fornecedor';
$lang['display_any_provider_hint'] = 'A página de reservas terá uma opção adicional que permite aos clientes reservar sem especificar um fornecedor.';
...
$lang['color'] = 'Cor';
$lang['matomo_analytics_url_hint'] = 'Adicione a URL da sua própria instalação do Matomo para habilitar o rastreamento Matomo nas páginas de reserva.';
$lang['invalid_phone'] = 'Número de telefone inválido.';
$lang['legal'] = 'Legal';
$lang['business'] = 'Empresa';
$lang['account'] = 'Conta';
$lang['disable_booking'] = 'Desativar Reserva';
$lang['disable_booking_hint'] = 'A página de reservas será desativada enquanto esta configuração estiver ativa e os clientes não poderão agendar novas consultas.';
$lang['display_message'] = 'Mostrar Mensagem';
$lang['booking_is_disabled'] = 'Reserva Está Desativada!';
$lang['appearance'] = 'Aparência';
$lang['company_logo'] = 'Logotipo da Empresa';
$lang['company_logo_hint'] = 'O logotipo da empresa será exibido em muitos locais do aplicativo, incluindo a página de reservas e os e-mails de notificação (arquivo de imagem, máx. 2MB).';
$lang['company_color'] = 'Cor da Empresa';
$lang['company_color_hint'] = 'A cor da empresa será aplicada em todo o aplicativo para que o aplicativo utilize sua marca.';
$lang['localization'] = 'Localização';
$lang['integrations'] = 'Integrações';
$lang['company'] = 'Empresa';
$lang['remove'] = 'Remover';
$lang['login_button'] = 'Botão de Login';
$lang['display_login_button_hint'] = 'Define se o botão de login está sendo exibido na página de reservas.';
$lang['private'] = 'Privado';
$lang['private_hint'] = 'Registos privados não serão exibidos ou processados em páginas públicas, como a página de reservas.';
$lang['reset'] = 'Reiniciar';
$lang['all'] = 'Todos';
$lang['booking_link'] = 'Link de Reserva';
$lang['add_new_event'] = 'Adicionar Novo Evento';
$lang['what_kind_of_event'] = 'Que tipo de evento gostaria de adicionar?';
$lang['theme'] = 'Tema';
$lang['limit_customer_access'] = 'Limitar Acesso do Cliente';
$lang['limit_customer_access_hint'] = 'Se ativado, os fornecedores e secretários só poderão acessar clientes com quem têm uma consulta agendada.';
$lang['url'] = 'URL';
$lang['secret_token'] = 'Token Secreto';
$lang['verify_ssl'] = 'Verificar SSL';
$lang['appointment_save'] = 'Salvar Consulta';
$lang['appointment_delete'] = 'Eliminar Consulta';
$lang['unavailability_save'] = 'Salvar Indisponibilidade';
$lang['unavailability_delete'] = 'Eliminar Indisponibilidade';
$lang['customer_save'] = 'Salvar Cliente';
$lang['customer_delete'] = 'Eliminar Cliente';
$lang['service_save'] = 'Salvar Serviço';
$lang['service_delete'] = 'Eliminar Serviço';
$lang['service_category_save'] = 'Salvar Categoria';
$lang['service_category_delete'] = 'Eliminar Categoria';
...
$lang['webhooks_info'] = 'Os webhooks permitem que você envie notificações HTTP para aplicativos web externos em resposta a vários eventos da aplicação, como a criação de uma consulta ou a remoção de um cliente.';
$lang['integrations_info'] = 'As integrações permitem que você faça conexões de terceiros com aplicativos externos e APIs.';
$lang['configure'] = 'Configurar';
$lang['google_analytics'] = 'Google Analytics';
$lang['google_analytics_info'] = 'O Google Analytics permite adicionar automaticamente o código de rastreamento e a marcação HTML à página pública e rastrear todas as sessões de reservas públicas.';
$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'O Matomo Analytics permite-lhe adicionar automaticamente o código de rastreamento e a marcação HTML à página pública e acompanhar todas as sessões de reservas públicas.';
$lang['api'] = 'API';
$lang['api_info'] = 'A API permite interagir com todos os dados do Easy!Appointments através do protocolo HTTP e dos endpoints disponíveis da API, e criar as suas próprias integrações.';
$lang['google_analytics_code'] = 'Código do Google Analytics';
$lang['matomo_analytics_url'] = 'URL do Matomo Analytics';
$lang['future_booking_limit'] = 'Limite de Reservas Futuras';
$lang['limit_days'] = 'Limite (Dias)';
$lang['future_booking_limit_hint'] = 'Defina o limite futuro em dias que os clientes podem fazer reservas através da página pública de reservas.';
$lang['api_token'] = 'Token da API';
$lang['allow_rescheduling_cancellation_before'] = 'Permitir Reagendamento/Cancelamento Antes';
$lang['at_least_one_field'] = 'Pelo menos um campo deve ser exibido na página de reservas.';
$lang['status'] = 'Estado';
$lang['appointment_status_options'] = 'Opções de Estado da Reserva';
$lang['appointment_status_options_info'] = 'Defina uma lista de opções de estado de reserva disponíveis que podem ser usadas na página do calendário (a primeira automaticamente se tornará o valor padrão).';
...
$lang['week_short'] = 'Sem';
$lang['scroll_to_increment'] = 'Desça para Incrementar';
$lang['year'] = 'Ano';
$lang['make_non_working_day'] = 'Este prestador não estará disponível para trabalho no dia selecionado.';
$lang['no_breaks'] = 'Sem Pausas';
$lang['service_categories'] = 'Categorias de Serviço';
$lang['service_category'] = 'Categoria de Serviço';
$lang['blocked_period_saved'] = 'Período bloqueado guardado com sucesso.';
$lang['blocked_period_deleted'] = 'Período bloqueado eliminado com sucesso.';
$lang['delete_blocked_period'] = 'Eliminar Período Bloqueado';
...
$lang['blocked_periods_hint'] = 'Defina períodos de tempo em que as reservas públicas serão desativadas para todos os prestadores (ex.: datas de fecho, feriados, etc.).';
$lang['custom_field'] = 'Campo Personalizado';
$lang['custom_fields'] = 'Campos Personalizados';
$lang['label'] = 'Rótulo';
$lang['webhook_saved'] = 'Webhook guardado com sucesso.';
$lang['webhook_deleted'] = 'Webhook eliminado com sucesso.';
$lang['delete_webhook'] = 'Eliminar Webhook';
$lang['contact_info'] = 'Informações de Contacto';
$lang['hide_from_public'] = 'Ocultar do Público';
$lang['matomo_analytics_site_id'] = 'ID do Site Matomo Analytics';
$lang['matomo_analytics_site_id_hint'] = 'Defina o ID do site que será monitorizado pelo Matomo (o site padrão tem o ID "1").';
$lang['default_timezone'] = 'Fuso Horário Padrão';
$lang['default_timezone_hint'] = 'Defina o valor do fuso horário padrão que será utilizado para novos registos.';
$lang['default_language'] = 'Língua Padrão';
$lang['default_language_hint'] = 'Defina o valor da língua padrão que será utilizado para novos registos.';
$lang['sync_method_prompt'] = 'Que método de sincronização gostaria de usar?';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar-se a um servidor LDAP existente e importar automaticamente utilizadores para o Easy!Appointments, permitindo que eles façam SSO com a sua password do diretório (o nome de utilizador deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
$lang['user_dn'] = 'DN do Utilizador';
$lang['base_dn'] = 'DN Base';
$lang['keyword'] = 'Palavra-chave';
$lang['ldap_search_hint'] = 'Forneça uma palavra-chave para pesquisar no diretório LDAP por utilizadores que correspondam aos critérios de filtro.';
...
$lang['active'] = 'Ativo';
$lang['user_imported'] = 'O registo do utilizador foi importado com sucesso.';
$lang['import'] = 'Importar';
$lang['ldap_dn'] = 'DN LDAP';
$lang['role'] = 'Função';
$lang['at_least_one_field_required'] = 'Pelo menos um campo deve ser definido como obrigatório na página de reservas.';
$lang['customer_is_already_booked'] = 'Este cliente já tem uma reserva durante o período solicitado.';
$lang['fields'] = 'Campos';
